...
-- (Removed review_reply; comments are no longer stored)

-- --------------------------------------------------------

--
-- Table structure for table `review_giver`
--

CREATE TABLE `review_giver` (
  `id_review_giver` int(11) NOT NULL,
  `kode_produk` varchar(100) NOT NULL,
  `kode_customer` varchar(100) NOT NULL,
  `tanggal` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
-- (defined inline in CREATE TABLE)
...
ALTER TABLE `review`
  ...
  ADD KEY `idx_review_produk` (`kode_produk`),
  ADD KEY `idx_review_customer` (`kode_customer`),
  ADD UNIQUE KEY `uniq_review_customer_product` (`kode_produk`,`kode_customer`);

--
-- Indexes for table `review_giver`
--
ALTER TABLE `review_giver`
  ADD PRIMARY KEY (`id_review_giver`),
  ADD KEY `idx_rg_produk` (`kode_produk`),
  ADD KEY `idx_rg_customer` (`kode_customer`),
  ADD UNIQUE KEY `uniq_rg_customer_product` (`kode_produk`,`kode_customer`);

--
-- (Removed indexes for review_reply)
...
--
-- AUTO_INCREMENT for table `review_giver`
--
ALTER TABLE `review_giver`
  MODIFY `id_review_giver` int(11) NOT NULL AUTO_INCREMENT;

--
-- (Removed AUTO_INCREMENT for review_reply)
COMMIT;
